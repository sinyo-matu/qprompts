...
class SelectTopic(PromptStructure):
    def __init__(self):
        super().__init__(
            name='ExamplePrompt',
    ...
    def render_sample(self, price: str, customer: str, product: str) -> list[ChatMessage]:
        return super().render_sample(price=price, customer=customer, product=product)

    def render_body(self, question: str, context: str, firstName: str) -> list[ChatMessage]:
        return super().render_body(question=question, context=context, firstName=firstName)
